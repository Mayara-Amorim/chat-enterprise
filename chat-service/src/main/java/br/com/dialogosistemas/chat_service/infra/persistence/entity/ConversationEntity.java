...
public class ConversationEntity {
    ...
    private MessagingPermission messagingPermission = MessagingPermission.ALL;
    ...
    public ConversationEntity(UUID id, UUID tenantId, ConversationType type, String title, UUID creatorId,
                               Instant createdAt, String lastMessageContent, Instant lastMessageAt,
                               String description, MessagingPermission messagingPermission, Instant dissolvedAt) {
        this.id = id;
    ...
    public void setMessagingPermission(MessagingPermission messagingPermission) { this.messagingPermission = messagingPermission; }
