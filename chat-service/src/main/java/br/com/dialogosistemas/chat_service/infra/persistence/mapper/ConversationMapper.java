...
public class ConversationMapper {
    ...
    public Conversation toDomain(ConversationEntity entity) {
        Set<ConversationParticipant> participants = entity.getParticipants().stream()
                .map(participant -> new ConversationParticipant(
                        ...
                        participant.isDeletedConversation()
                ))
        ...
        return new Conversation(
                ...
                entity.getMessagingPermission(),
                entity.getDissolvedAt()
        );
    }
    ...
    public ConversationEntity toEntity(Conversation domain) {
        ...
        entity.setMessagingPermission(domain.getMessagingPermission());
        entity.setDissolvedAt(domain.getDissolvedAt());
        ...
        domain.getParticipants().forEach(participant -> {
            ...
            participantEntity.setLeftAt(participant.getLeftAt());
            participantEntity.setDeletedConversation(participant.isDeletedConversation());
