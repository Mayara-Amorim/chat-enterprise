...
class GroupRulesStompIntegrationTest {
    ...
    void subscribedClientReceivesRulesMessageBroadcastFromKafka() throws Exception {
        ...
        connectHeaders.add("Authorization", "Bearer " + TestSecurityConfig.generateJwt(senderId, UUID.randomUUID()));
    ...
    void subscribedClientReceivesDeletedEventWhenDeleteEndpointReturnsNoContent() throws Exception {
        ...
        StompHeaders connectHeaders = new StompHeaders();
        connectHeaders.add("Authorization", "Bearer " + TestSecurityConfig.generateJwt(seeded.adminId(), seeded.tenantId()));
    ...
    void subscribedClientReceivesEditedEventWhenPatchEndpointReturnsNoContent() throws Exception {
        ...
        StompHeaders connectHeaders = new StompHeaders();
        connectHeaders.add("Authorization", "Bearer " + TestSecurityConfig.generateJwt(seeded.memberId(), seeded.tenantId()));
